...
class ScenarioLoop(Scenario):
    ...
    def __init__(self, scenario_id: int, short_description: str, tags, path: str, line: int, steps, iterations) -> None:
    ...
    def __repr__(self) -> str:
        return "<ScenarioLoop: '{short_description} with {iterations} Iterations @ {path}:{line}>".format(
            short_description=self.short_description, iterations=self.iterations,
