...
class RadishGherkinTransformer(Transformer):
    ...
    def prepare(self, featurefile_path: Path, featurefile_contents: str, feature_id: int):
    ...
    def scenario_outline(self, subtree):
        ...
        steps = list(itertools.takewhile(lambda s: isinstance(s, Step), subtree[len(tags) + 1:]))
