...
class ScenarioLoop(Scenario):
    ...
    """
    def __init__(self, absolute_id, id, keyword, iterations_keyword, sentence, path, line, parent):
        super(ScenarioLoop, self).__init__(absolute_id, id, keyword, sentence, path, line, parent)
