...
class ScenarioOutline(Scenario):
    ...
    def __init__(self, absolute_id, id, keyword, example_keyword, sentence, path, line, parent):
        super(ScenarioOutline, self).__init__(absolute_id, id, keyword, sentence, path, line, parent)
