...
def main():
    ...
    setup(
        ...
        # bugtrack_url is broken, see:
        # - https://github.com/pypa/setuptools/issues/906
        # - https://bugs.python.org/issue29115
        # - https://github.com/pypa/setuptools/issues/29
        ...
        entry_points={
            "console_scripts": [
                ...
                'radish-docs = radish.documentors.__main__:main',
            ]},
        classifiers=[
